...
const articles = Object.values(modules) as Article[];
...
<template>
    ...
    <section class="text-center py-5">
        <div class="container">
            <h1 class="display-5 fw-bold">Krav Maga Veurey-Voroize Noyarey</h1>
            <img src="/Pictures/kmvn_logo.png" alt="Krav Maga Veurey-Voroize" style="max-height: 150px;">
            <p class="lead">Self-défense réaliste pour tous · Saison 2026–2027</p>
